/*
 * Purpose : Demos how static blocks work
 *
...
public class AStaticBlock {
	...
	static { // static Block A
		System.out.println("Static Block A : In the Static Block!. And this gets executed the moment the class gets loaded! and only once!");
	}
	...
	static { // static Block B
		System.out.println(
				"Static Block B : a separate Static Block. Placed after the main function. " + "And still gets executed before main is called, but after the Static block A");
	}
